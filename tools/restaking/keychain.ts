...
const devnet: KeychainConfig<keyof (typeof keypairs)> = {
    ...
    keypairs: {
        ...
        'FRAGSOL_WRAPPED_TOKEN_MINT': './keypairs/restaking/wfragsol_mint_WFRGSWjaz8tbAxsJitmbfRuFV2mSNwy7BMWcCwaA28U.json',
        'FRAGJTO_WRAPPED_TOKEN_MINT': './keypairs/restaking/wfragjto_mint_WFRGJnQt5pK8Dv4cDAbrSsgPcmboysrmX3RYhmRRyTR.json',
