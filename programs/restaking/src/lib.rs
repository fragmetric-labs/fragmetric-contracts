...
pub mod restaking {
    ...
    ////////////////////////////////////////////
    // FundManagerFundRewardTokenContext
    ////////////////////////////////////////////

    pub fn fund_manager_revoke_fund_reward_token_mint_authority(
        ctx: Context<FundManagerFundRewardTokenContext>,
    ) -> Result<()> {
        modules::fund::FundConfigurationService::new(
            &mut ctx.accounts.receipt_token_mint,
            &mut ctx.accounts.fund_account,
        )?
        .process_revoke_reward_token_mint_authority(
    ...
    pub fn user_close_fund_account(ctx: Context<UserFundAccountCloseContext>) -> Result<()> {
        emit_cpi!(modules::fund::UserFundConfigurationService::new(
            &ctx.accounts.receipt_token_mint,
            &mut ctx.accounts.user_fund_account
        )?
        .process_close_user_fund_account(&ctx.accounts.user)?);
