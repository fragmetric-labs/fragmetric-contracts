...
#[constant]
pub const DEVNET_JITOSOL_MINT_ADDRESS: Pubkey = MAINNET_JITOSOL_MINT_ADDRESS;
#[constant]
pub const MAINNET_JITOSOL_STAKE_POOL_ADDRESS: Pubkey =
    pubkey!("Jito4APyf642JPZPx3hGc6WWJ8zPKtRbRs4P815Awbb");
#[constant]
pub const DEVNET_JITOSOL_STAKE_POOL_ADDRESS: Pubkey = MAINNET_JITOSOL_STAKE_POOL_ADDRESS;
...
#[constant]
pub const DEVNET_JTO_MINT_ADDRESS: Pubkey = pubkey!("FAkEjwHSbxkojmdiMurSXR11dU5jbfoqVhtjFCXbM1hh");
...
#[constant]
pub const DEVNET_JTO_LIQUIDITY_POOL_ADDRESS: Pubkey =
    pubkey!("BQQVo6sz9pTjD1P88C7WgCo4ABLxr8PM6Ycu4fzDZmBQ");
