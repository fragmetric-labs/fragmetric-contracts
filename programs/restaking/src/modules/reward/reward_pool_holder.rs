...
const REWARD_ACCOUNT_HOLDER_NAME_MAX_LEN: usize = 14;
const REWARD_ACCOUNT_HOLDER_DESCRIPTION_MAX_LEN: usize = 128;
const REWARD_ACCOUNT_HOLDER_PUBKEYS_MAX_LEN_1: usize = 8;
...
pub struct RewardPoolHolder {
    ...
    pub(super) id: u8,
    name: [u8; REWARD_ACCOUNT_HOLDER_NAME_MAX_LEN],
    description: [u8; REWARD_ACCOUNT_HOLDER_DESCRIPTION_MAX_LEN],
    ...
    pubkeys_1: [Pubkey; REWARD_ACCOUNT_HOLDER_PUBKEYS_MAX_LEN_1],
}
...
impl RewardPoolHolder {
    pub(super) fn initialize(
        ...
        require_gte!(
            REWARD_ACCOUNT_HOLDER_NAME_MAX_LEN,
            name.len(),
            ErrorCode::RewardInvalidMetadataNameLengthError
        );
        require_gte!(
            REWARD_ACCOUNT_HOLDER_DESCRIPTION_MAX_LEN,
            description.len(),
            ErrorCode::RewardInvalidMetadataDescriptionLengthError
        );
        require_gte!(
            REWARD_ACCOUNT_HOLDER_PUBKEYS_MAX_LEN_1,
            pubkeys.len(),
