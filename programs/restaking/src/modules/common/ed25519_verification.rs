...
pub struct Ed25519Instruction(Instruction);

impl Ed25519Instruction {
    pub fn new_from_instruction_sysvar(instruction_sysvar: &AccountInfo) -> Result<Self> {
    ...
    pub fn verify(&self, pubkey: &[u8], payload: &[u8]) -> Result<()> {
