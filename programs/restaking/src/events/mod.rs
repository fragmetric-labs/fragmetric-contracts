...
mod user_closed_fund_account;
mod user_closed_reward_account;
...
pub use user_closed_fund_account::*;
pub use user_closed_reward_account::*;
...
pub use user_deposited_to_vault::*;
