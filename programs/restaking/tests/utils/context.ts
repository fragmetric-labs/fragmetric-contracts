    ...
    mock: {
      ...
      programs: [
        ...
        },
        {
          ...
          soFilePath: '../mocks/metaplex.so',
        },
        {
          pubkey: 'SPoo1Ku8WFXoNDMHPsrGSTSG1Y47rzgn41SLUNakuHy',
          soFilePath: '../mocks/spl_stake_pool.so',
        },
        {
          pubkey: 'MarBmsSgKXdrN1egZf5sqe1TMai9K1rChYNDJgjq7aD',
          soFilePath: '../mocks/marinade_stake_pool.so',
        },
        {
          pubkey: 'SP12tWFxD9oJsVWNavTTBZvMbA6gkAmxtVgxdqvyvhY',
          soFilePath: '../mocks/sanctum_single_validator_stake_pool.so',
        },
        {
          pubkey: 'Vau1t6sLNxnzB7ZDsef8TLbPLfyZMYXH8WTNqUdm9g8',
          soFilePath: '../mocks/jito_vault.so',
        },
        {
          pubkey: 'RestkWeAVL8fRGgzhfeoqFhsqKRchg6aa1XrcH96z4Q',
          soFilePath: '../mocks/jito_restaking.so',
        },
        {
          pubkey: 'whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc',
          soFilePath: '../mocks/orca_whirlpool.so',
        },
      ],
      accounts: [
        {
          jsonFileDirPath: '../mocks',
        },
      ],
    },
  });
