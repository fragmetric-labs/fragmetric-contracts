...
test('can traverse context graph', async () => {
  expect(
    ...
    │   │   │   │   ├── updatePools                                TransactionTemplate args=null, events=userUpdatedRewardPool, description=manually triggers contribution synchronization for the user rewa
    ...
    │   │   │   │   └── resetDelegate                              TransactionTemplate args=null, events=userDelegatedRewardAccount, description=reset delegate of reward account (in case of either fund wr
    ...
    │   │   ├── updatePrices                                       TransactionTemplate args=null, events=operatorUpdatedFundPrices, description=manually triggers price updates for the receipt token and un
    │   │   ├── donate                                             TransactionTemplate args=assetMint,assetAmount,offsetReceivable,applyPresetComputeUnitLimit, events=operatorDonatedToFund, description=do
    ...
    │   │   ├── updateGeneralStrategy                              TransactionTemplate args=depositEnabled,donationEnabled,transferEnabled,withdrawalEnabled,withdrawalBatchThresholdSeconds,withdrawalFeeRa
    ...
    │   │   ├── addRestakingVaultCompoundingReward                 TransactionTemplate args=vault,rewardTokenMint, events=fundManagerUpdatedFund, description=add a new compounding reward to a restaking va
    │   │   ├── removeRestakingVaultCompoundingReward              TransactionTemplate args=vault,rewardTokenMint, events=fundManagerUpdatedFund, description=remove a compounding reward from a restaking v
    │   │   ├── addRestakingVaultDistributingReward                TransactionTemplate args=vault,rewardTokenMint, events=fundManagerUpdatedFund, description=add a new distributing reward to a restaking v
    │   │   ├── updateRestakingVaultDistributingRewardThreshold    TransactionTemplate args=vault,rewardTokenMint,thresholdMinAmount,thresholdMaxAmount,thresholdIntervalSeconds, events=fundManagerUpdatedF
    │   │   ├── removeRestakingVaultDistributingReward             TransactionTemplate args=vault,rewardTokenMint, events=fundManagerUpdatedFund, description=remove a distributing reward from a restaking 
    ...
    │   │   └── initializeWrappedTokenHolder                       TransactionTemplate args=wrappedTokenAccount, events=userCreatedOrUpdatedRewardAccount,fundManagerUpdatedFund, description=add new wrappe
    ...
    │   │   ├── updatePools                                        TransactionTemplate args=null, events=operatorUpdatedRewardPools, description=manually triggers contribution synchronization for the glob
    ...
    │   │   ├── addReward                                          TransactionTemplate args=mint,program,decimals,name,description, events=fundManagerUpdatedRewardPool, description=register a new reward (
    │   │   ├── updateReward                                       TransactionTemplate args=mint,newMint,newProgram,newDecimals,claimable, events=fundManagerUpdatedRewardPool, description=update a non-cla
    ...
    │   │   ├── supportedTokens                                    IterativeAccount length=undefined, types=undefined
    │   │   ├── updatePrices                                       TransactionTemplate args=null, events=operatorUpdatedNormalizedTokenPoolPrices, description=manually triggers price updates for the norma
    ...
    │   │   ├── supportedTokens                                    IterativeAccount length=undefined, types=undefined
    │   │   ├── rewardTokens                                       IterativeAccount length=undefined, types=undefined
    │   │   ├── deposit                                            TransactionTemplate args=assetMint,assetAmount,metadata,applyPresetComputeUnitLimit, events=userDepositedToFund,userCreatedOrUpdatedFundA
    │   │   ├── requestWithdrawal                                  TransactionTemplate args=assetMint,receiptTokenAmount, events=userRequestedWithdrawalFromFund,userCreatedOrUpdatedFundAccount,userCreated
    │   │   ├── cancelWithdrawalRequest                            TransactionTemplate args=assetMint,requestId, events=userCanceledWithdrawalRequestFromFund,userCreatedOrUpdatedFundAccount,userCreatedOrU
    │   │   ├── withdraw                                           TransactionTemplate args=assetMint,requestId, events=userWithdrewFromFund,userCreatedOrUpdatedFundAccount,userCreatedOrUpdatedRewardAccou
    │   │   ├── wrap                                               TransactionTemplate args=receiptTokenAmount,receiptTokenAmountAsTargetBalance, events=userWrappedReceiptToken, description=convert receip
    │   │   ├── unwrap                                             TransactionTemplate args=wrappedTokenAmount, events=userUnwrappedReceiptToken, description=convert wrapped tokens back into receipt token
