...
export function getFundManagerWithdrawInstructionDataEncoder(): Encoder<FundManagerWithdrawInstructionDataArgs> {
...
export function getFundManagerWithdrawInstructionDataDecoder(): Decoder<FundManagerWithdrawInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getFundManagerWithdrawInstructionDataCodec(): Codec<
