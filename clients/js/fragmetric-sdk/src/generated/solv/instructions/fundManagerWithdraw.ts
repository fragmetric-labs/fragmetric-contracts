...
export const FUND_MANAGER_WITHDRAW_DISCRIMINATOR = new Uint8Array([
  200, 145, 159, 50, 26, 63, 31, 186,
]);

export function getFundManagerWithdrawDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    FUND_MANAGER_WITHDRAW_DISCRIMINATOR
  );
}

export type FundManagerWithdrawInstruction<
...
export type FundManagerWithdrawInstructionData = {
  discriminator: ReadonlyUint8Array;
};

export type FundManagerWithdrawInstructionDataArgs = {};

export function getFundManagerWithdrawInstructionDataEncoder(): FixedSizeEncoder<FundManagerWithdrawInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({
      ...value,
      discriminator: FUND_MANAGER_WITHDRAW_DISCRIMINATOR,
    })
  );
}

export function getFundManagerWithdrawInstructionDataDecoder(): FixedSizeDecoder<FundManagerWithdrawInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getFundManagerWithdrawInstructionDataCodec(): FixedSizeCodec<
  FundManagerWithdrawInstructionDataArgs,
  FundManagerWithdrawInstructionData
> {
  return combineCodec(
    getFundManagerWithdrawInstructionDataEncoder(),
    getFundManagerWithdrawInstructionDataDecoder()
  );
}

export type FundManagerWithdrawAsyncInput<
...
export async function getFundManagerWithdrawInstructionAsync<
  TAccountPayer extends string,
  TAccountFundManager extends string,
  TAccountVaultAccount extends string,
  TAccountVaultReceiptTokenMint extends string,
...
>(
  input: FundManagerWithdrawAsyncInput<
    TAccountPayer,
    TAccountFundManager,
    TAccountVaultAccount,
    TAccountVaultReceiptTokenMint,
  ...
  FundManagerWithdrawInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountFundManager,
    TAccountVaultAccount,
...
> {
  ...
  return Object.freeze({
    ...
    data: getFundManagerWithdrawInstructionDataEncoder().encode({}),
    programAddress,
  } as FundManagerWithdrawInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountFundManager,
    TAccountVaultAccount,
...
export type FundManagerWithdrawInput<
  TAccountPayer extends string = string,
  TAccountFundManager extends string = string,
  TAccountVaultAccount extends string = string,
  TAccountVaultReceiptTokenMint extends string = string,
...
export function getFundManagerWithdrawInstruction<
  TAccountPayer extends string,
  TAccountFundManager extends string,
  TAccountVaultAccount extends string,
  TAccountVaultReceiptTokenMint extends string,
  ...
  TProgramAddress extends Address = typeof SOLV_PROGRAM_ADDRESS,
>(
  input: FundManagerWithdrawInput<
    TAccountPayer,
    TAccountFundManager,
    TAccountVaultAccount,
    TAccountVaultReceiptTokenMint,
...
export type ParsedFundManagerWithdrawInstruction<
  TProgram extends string = typeof SOLV_PROGRAM_ADDRESS,
...
> = {
  ...
  data: FundManagerWithdrawInstructionData;
};

export function parseFundManagerWithdrawInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedFundManagerWithdrawInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getFundManagerWithdrawInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
