...
export type RewardManagerDelegateRewardTokenAccountInstruction<
  ...
  TAccountRewardManager extends string | AccountMeta<string> = string,
  ...
  TAccountRewardTokenAccount extends string | AccountMeta<string> = string,
    ...
    [
      TAccountRewardManager extends string
        ? ReadonlySignerAccount<TAccountRewardManager> &
            AccountSignerMeta<TAccountRewardManager>
...
export function getRewardManagerDelegateRewardTokenAccountInstructionDataEncoder(): FixedSizeEncoder<RewardManagerDelegateRewardTokenAccountInstructionDataArgs> {
...
export function getRewardManagerDelegateRewardTokenAccountInstructionDataDecoder(): FixedSizeDecoder<RewardManagerDelegateRewardTokenAccountInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getRewardManagerDelegateRewardTokenAccountInstructionDataCodec(): FixedSizeCodec<
