...
export const FUND_MANAGER_INITIALIZE_FUND_SOLV_BTC_VAULT_DISCRIMINATOR =
  new Uint8Array([98, 98, 53, 208, 226, 109, 32, 198]);

export function getFundManagerInitializeFundSolvBtcVaultDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    FUND_MANAGER_INITIALIZE_FUND_SOLV_BTC_VAULT_DISCRIMINATOR
  );
}

export type FundManagerInitializeFundSolvBtcVaultInstruction<
...
export type FundManagerInitializeFundSolvBtcVaultInstructionData = {
  discriminator: ReadonlyUint8Array;
};

export type FundManagerInitializeFundSolvBtcVaultInstructionDataArgs = {};

export function getFundManagerInitializeFundSolvBtcVaultInstructionDataEncoder(): Encoder<FundManagerInitializeFundSolvBtcVaultInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({
      ...value,
      discriminator: FUND_MANAGER_INITIALIZE_FUND_SOLV_BTC_VAULT_DISCRIMINATOR,
    })
  );
}

export function getFundManagerInitializeFundSolvBtcVaultInstructionDataDecoder(): Decoder<FundManagerInitializeFundSolvBtcVaultInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getFundManagerInitializeFundSolvBtcVaultInstructionDataCodec(): Codec<
  FundManagerInitializeFundSolvBtcVaultInstructionDataArgs,
  FundManagerInitializeFundSolvBtcVaultInstructionData
> {
  return combineCodec(
    getFundManagerInitializeFundSolvBtcVaultInstructionDataEncoder(),
    getFundManagerInitializeFundSolvBtcVaultInstructionDataDecoder()
  );
}

export type FundManagerInitializeFundSolvBtcVaultAsyncInput<
...
export async function getFundManagerInitializeFundSolvBtcVaultInstructionAsync<
  TAccountFundManager extends string,
  TAccountSystemProgram extends string,
  TAccountFundAccount extends string,
  TAccountFundReserveAccount extends string,
...
>(
  input: FundManagerInitializeFundSolvBtcVaultAsyncInput<
    TAccountFundManager,
    TAccountSystemProgram,
    TAccountFundAccount,
    TAccountFundReserveAccount,
  ...
  FundManagerInitializeFundSolvBtcVaultInstruction<
    TProgramAddress,
    TAccountFundManager,
    TAccountSystemProgram,
    TAccountFundAccount,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getFundManagerInitializeFundSolvBtcVaultInstructionDataEncoder().encode(
      {}
    ),
  } as FundManagerInitializeFundSolvBtcVaultInstruction<
    TProgramAddress,
    TAccountFundManager,
    TAccountSystemProgram,
    TAccountFundAccount,
...
export type FundManagerInitializeFundSolvBtcVaultInput<
  TAccountFundManager extends string = string,
  TAccountSystemProgram extends string = string,
  TAccountFundAccount extends string = string,
  TAccountFundReserveAccount extends string = string,
...
export function getFundManagerInitializeFundSolvBtcVaultInstruction<
  TAccountFundManager extends string,
  TAccountSystemProgram extends string,
  TAccountFundAccount extends string,
  TAccountFundReserveAccount extends string,
  ...
  TProgramAddress extends Address = typeof RESTAKING_PROGRAM_ADDRESS,
>(
  input: FundManagerInitializeFundSolvBtcVaultInput<
    TAccountFundManager,
    TAccountSystemProgram,
    TAccountFundAccount,
    TAccountFundReserveAccount,
...
export type ParsedFundManagerInitializeFundSolvBtcVaultInstruction<
  TProgram extends string = typeof RESTAKING_PROGRAM_ADDRESS,
...
> = {
  ...
  data: FundManagerInitializeFundSolvBtcVaultInstructionData;
};

export function parseFundManagerInitializeFundSolvBtcVaultInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedFundManagerInitializeFundSolvBtcVaultInstruction<
  TProgram,
  TAccountMetas
> {
  ...
  return {
    ...
    data: getFundManagerInitializeFundSolvBtcVaultInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
