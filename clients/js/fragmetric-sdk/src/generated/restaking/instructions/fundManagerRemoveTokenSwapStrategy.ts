...
export type FundManagerRemoveTokenSwapStrategyInstruction<
  ...
  TAccountFromTokenMint extends string | AccountMeta<string> = string,
  TAccountToTokenMint extends string | AccountMeta<string> = string,
  TAccountSwapSourceAccount extends string | AccountMeta<string> = string,
...
export function getFundManagerRemoveTokenSwapStrategyInstructionDataEncoder(): FixedSizeEncoder<FundManagerRemoveTokenSwapStrategyInstructionDataArgs> {
...
export function getFundManagerRemoveTokenSwapStrategyInstructionDataDecoder(): FixedSizeDecoder<FundManagerRemoveTokenSwapStrategyInstructionData> {
...
export function getFundManagerRemoveTokenSwapStrategyInstructionDataCodec(): FixedSizeCodec<
