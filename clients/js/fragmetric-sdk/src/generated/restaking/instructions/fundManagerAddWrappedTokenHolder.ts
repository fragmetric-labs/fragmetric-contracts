...
export function getFundManagerAddWrappedTokenHolderInstructionDataEncoder(): FixedSizeEncoder<FundManagerAddWrappedTokenHolderInstructionDataArgs> {
...
export function getFundManagerAddWrappedTokenHolderInstructionDataDecoder(): FixedSizeDecoder<FundManagerAddWrappedTokenHolderInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getFundManagerAddWrappedTokenHolderInstructionDataCodec(): FixedSizeCodec<
