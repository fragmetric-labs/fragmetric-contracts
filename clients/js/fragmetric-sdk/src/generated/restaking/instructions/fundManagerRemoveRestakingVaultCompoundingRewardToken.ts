...
export const FUND_MANAGER_REMOVE_RESTAKING_VAULT_COMPOUNDING_REWARD_TOKEN_DISCRIMINATOR =
  new Uint8Array([103, 237, 63, 36, 105, 160, 171, 66]);

export function getFundManagerRemoveRestakingVaultCompoundingRewardTokenDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    FUND_MANAGER_REMOVE_RESTAKING_VAULT_COMPOUNDING_REWARD_TOKEN_DISCRIMINATOR
  );
}

export type FundManagerRemoveRestakingVaultCompoundingRewardTokenInstruction<
...
export function getFundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataEncoder(): FixedSizeEncoder<FundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataArgs> {
...
export function getFundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataDecoder(): FixedSizeDecoder<FundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionData> {
...
export function getFundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataCodec(): FixedSizeCodec<
  FundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataArgs,
  FundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionData
> {
  return combineCodec(
    getFundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataEncoder(),
    getFundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataDecoder()
  );
}

export type FundManagerRemoveRestakingVaultCompoundingRewardTokenAsyncInput<
...
>(
  input: FundManagerRemoveRestakingVaultCompoundingRewardTokenAsyncInput<
    TAccountFundManager,
    TAccountReceiptTokenMint,
    TAccountFundAccount,
    TAccountRewardTokenMint,
  ...
  FundManagerRemoveRestakingVaultCompoundingRewardTokenInstruction<
    TProgramAddress,
    TAccountFundManager,
    TAccountReceiptTokenMint,
    TAccountFundAccount,
...
> {
  ...
  return Object.freeze({
    ...
    data: getFundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataEncoder().encode(
      args as FundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataArgs
    ),
    programAddress,
  } as FundManagerRemoveRestakingVaultCompoundingRewardTokenInstruction<
    TProgramAddress,
    TAccountFundManager,
    TAccountReceiptTokenMint,
    TAccountFundAccount,
...
export type FundManagerRemoveRestakingVaultCompoundingRewardTokenInput<
  TAccountFundManager extends string = string,
  TAccountReceiptTokenMint extends string = string,
  TAccountFundAccount extends string = string,
  TAccountRewardTokenMint extends string = string,
...
export function getFundManagerRemoveRestakingVaultCompoundingRewardTokenInstruction<
  ...
  TProgramAddress extends Address = typeof RESTAKING_PROGRAM_ADDRESS,
>(
  input: FundManagerRemoveRestakingVaultCompoundingRewardTokenInput<
    TAccountFundManager,
    TAccountReceiptTokenMint,
    TAccountFundAccount,
    TAccountRewardTokenMint,
...
export type ParsedFundManagerRemoveRestakingVaultCompoundingRewardTokenInstruction<
  TProgram extends string = typeof RESTAKING_PROGRAM_ADDRESS,
...
export function parseFundManagerRemoveRestakingVaultCompoundingRewardTokenInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedFundManagerRemoveRestakingVaultCompoundingRewardTokenInstruction<
  TProgram,
  TAccountMetas
> {
  ...
  return {
    ...
    data: getFundManagerRemoveRestakingVaultCompoundingRewardTokenInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
