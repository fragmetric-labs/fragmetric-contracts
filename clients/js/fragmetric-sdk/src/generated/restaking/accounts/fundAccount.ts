...
export function getFundAccountEncoder(): FixedSizeEncoder<FundAccountArgs> {
...
export function getFundAccountDecoder(): FixedSizeDecoder<FundAccount> {
  return getStructDecoder([
    ...
    ['reserved2', fixDecoderSize(getBytesDecoder(), 14192)],
    ['numPricingSourceAddresses', getU8Decoder()],
    [
      'pricingSourceAddresses',
      getArrayDecoder(getAddressDecoder(), { size: 33 }),
    ],
    ['reserved3', fixDecoderSize(getBytesDecoder(), 767)],
...
export function getFundAccountCodec(): FixedSizeCodec<
  FundAccountArgs,
  FundAccount
> {
