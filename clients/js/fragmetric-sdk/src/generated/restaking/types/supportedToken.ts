...
export function getSupportedTokenEncoder(): FixedSizeEncoder<SupportedTokenArgs> {
...
export function getSupportedTokenDecoder(): FixedSizeDecoder<SupportedToken> {
...
export function getSupportedTokenCodec(): FixedSizeCodec<
  SupportedTokenArgs,
  SupportedToken
> {
