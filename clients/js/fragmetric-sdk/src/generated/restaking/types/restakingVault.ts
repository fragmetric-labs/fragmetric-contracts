...
export function getRestakingVaultEncoder(): FixedSizeEncoder<RestakingVaultArgs> {
...
export function getRestakingVaultDecoder(): FixedSizeDecoder<RestakingVault> {
...
export function getRestakingVaultCodec(): FixedSizeCodec<
  RestakingVaultArgs,
  RestakingVault
> {
