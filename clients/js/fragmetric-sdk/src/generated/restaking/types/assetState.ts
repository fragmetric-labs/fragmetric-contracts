...
export function getAssetStateEncoder(): Encoder<AssetStateArgs> {
...
export function getAssetStateDecoder(): Decoder<AssetState> {
...
export function getAssetStateCodec(): Codec<AssetStateArgs, AssetState> {
