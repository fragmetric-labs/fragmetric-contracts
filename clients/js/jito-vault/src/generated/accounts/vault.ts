...
export type Vault = {
  ...
  nextWithdrawalFeeBps: PodU16;
  rewardFeeBps: PodU16;
  programFeeBps: PodU16;
  bump: number;
  isPaused: PodBool;
  lastStartStateUpdateSlot: PodU64;
...
export type VaultArgs = {
  ...
  nextWithdrawalFeeBps: PodU16Args;
  rewardFeeBps: PodU16Args;
  programFeeBps: PodU16Args;
  bump: number;
  isPaused: PodBoolArgs;
  lastStartStateUpdateSlot: PodU64Args;
  reserved: ReadonlyUint8Array;
};
...
export function getVaultEncoder(): Encoder<VaultArgs> {
  return getStructEncoder([
    ...
    ['depositCapacity', getPodU64Encoder()],
    ...
    ['nextWithdrawalFeeBps', getPodU16Encoder()],
    ['rewardFeeBps', getPodU16Encoder()],
    ['programFeeBps', getPodU16Encoder()],
    ['bump', getU8Encoder()],
    ['isPaused', getPodBoolEncoder()],
    ['lastStartStateUpdateSlot', getPodU64Encoder()],
    ['reserved', fixEncoderSize(getBytesEncoder(), 251)],
  ]);
}
...
export function getVaultDecoder(): Decoder<Vault> {
  return getStructDecoder([
    ...
    ['depositCapacity', getPodU64Decoder()],
    ...
    ['nextWithdrawalFeeBps', getPodU16Decoder()],
    ['rewardFeeBps', getPodU16Decoder()],
    ['programFeeBps', getPodU16Decoder()],
    ['bump', getU8Decoder()],
    ['isPaused', getPodBoolDecoder()],
    ['lastStartStateUpdateSlot', getPodU64Decoder()],
    ['reserved', fixDecoderSize(getBytesDecoder(), 251)],
  ]);
}
