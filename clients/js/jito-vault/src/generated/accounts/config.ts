...
export type Config = {
  ...
  epochLength: PodU64;
  numVaults: PodU64;
  depositWithdrawalFeeCapBps: PodU16;
...
export type ConfigArgs = {
  ...
  depositWithdrawalFeeCapBps: PodU16Args;
...
export function getConfigEncoder(): Encoder<ConfigArgs> {
  return getStructEncoder([
    ...
    ['depositWithdrawalFeeCapBps', getPodU16Encoder()],
    ...
    ['bump', getU8Encoder()],
    ['reserved', fixEncoderSize(getBytesEncoder(), 229)],
  ]);
}
...
export function getConfigDecoder(): Decoder<Config> {
  return getStructDecoder([
    ...
    ['depositWithdrawalFeeCapBps', getPodU16Decoder()],
    ...
    ['bump', getU8Decoder()],
    ['reserved', fixDecoderSize(getBytesDecoder(), 229)],
  ]);
}
