...
## 1. JavaScript SDK (js/fragmetric-sdk)

```sh
# Initialization
$ yarn workspace @fragmetric-labs/sdk install

# Do dev locally with your ./target/idl/* IDLs
$ yarn workspace @fragmetric-labs/sdk dev:local

# Do dev/build/test for SDK with included stable IDLs
$ yarn workspace @fragmetric-labs/sdk dev # watch all and build
...
## 2. Node.js Playground (js/fragmetric-playground)
...


## 3. Codegen
It generates JavaScript, Rust codebase utilizing [codama](https://github.com/codama-idl/codama) library.
...
Note that all JS packages require `@solana/web3.js@2`.
